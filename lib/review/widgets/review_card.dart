...
class ReviewCard extends StatelessWidget {
  ...
  Future<void> _removeReview(
    ...
    await request.postJson(
        ...
        jsonEncode(<String, int>{"book-id": book.pk, "review-id": review.pk}));
  }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                StarGenerator(starsCount: (review.fields.rating).toDouble()),
                const SizedBox(
                  width: 6,
                ),
            ...
            Row(
              ...
              children: [
                ...
                if (review.fields.comment.length > 150 ||
                    review.fields.reviewer.length > 10)
                  TextButton(
                    onPressed: () {
                      ...
                      TextButton(
                          onPressed: () async {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => ReviewUpdatePage(
                                  book: book,
                                  review: review,
                                ),
                              ),
